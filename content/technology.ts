...
export const technologyArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    spoiler: "Low",
    description:
      "Socketed chips that supply information or trained competencies directly to a user, a fictional generic term unrelated to the software company in ordinary usage.",
    intro: [
      "In Neuromancer, a microsoft is a small module fitted into a socket behind the ear. Different chips provide specialized knowledge or capability, allowing information to be worn and exchanged as an object rather than learned through ordinary study.",
      "The word is easy to misread after the rise of Microsoft Corporation, but the novel uses it as a common noun inside its own material culture. Gibson does not give a complete catalogue or establish that a chip duplicates every dimension of genuine expertise.",
    ],
    keyFacts: [
      { label: "Form", value: "Removable chip or module" },
      { label: "Interface", value: "Socket behind the ear" },
      { label: "Purpose", value: "Supply information or specialized capability" },
      { label: "Ownership", value: "Portable and exchangeable" },
      { label: "Spelling", value: "Lowercase generic noun in the fictional setting" },
      { label: "Not equivalent to", value: "Microsoft Corporation or a cyberspace deck" },
    ],
    sections: [
      {
        id: "plug-in-knowledge",
        heading: "Plug-in knowledge",
        body: [
          "Microsofts turn knowledge into hardware inventory. A person can acquire a module for a task, insert it, and gain access to information without a conventional education. The model fits a setting where bodies are platforms and competencies circulate through markets.",
          "The novel's casual treatment of the modules is part of their significance. Characters do not stop to marvel that information can be socketed; they distinguish useful chips, interfaces, and professional judgment as ordinary categories of equipment. A microsoft can therefore lower the cost of possessing facts while leaving social position unchanged. The person still needs money or underworld access to obtain the chip, a modified body that accepts it, and enough context to act on what it supplies. Knowledge has become portable merchandise, not automatically equal or free.",
        ],
      },
      {
        id: "socket",
        heading: "The socket",
        body: [
          "The behind-the-ear interface is a permanent bodily modification supporting removable media. It differs from dermatrodes, which contact the skin for a live system connection, and from a personality construct, which stores a modeled person rather than a user skill.",
        ],
      },
      {
        id: "limits",
        heading: "Limits of the technology",
        body: [
          "The narrative treats microsofts as useful and ordinary but does not make learning obsolete. Judgment, reflexes, personal memory, and social experience remain unevenly distributed. A chip may supply data without making its wearer a Case, Molly, or Hideo.",
        ],
      },
      {
        id: "name-confusion",
        heading: "A name changed by history",
        body: [
          "Modern readers encounter an accidental collision between Gibson's fictional noun and a dominant real company name. The encyclopedia should preserve the lowercase fictional usage and explain the distinction instead of retroactively turning every mention into a corporate reference.",
        ],
      },
      {
        id: "microsoft-evidence",
        heading: "Evidence from use and comparison",
        body: [
          "Characters handle microsofts as compact, replaceable resources rather than as personalities. They can be inserted for access to a body of knowledge and removed when that capacity is no longer needed. The behind-the-ear socket makes the user a hardware platform, but nothing in the scenes suggests the chip takes control of the person's motives or supplies a complete new identity.",
          "Comparison with Dixie clarifies the boundary. A ROM construct speaks from a recorded life and can object to its continued existence; a microsoft provides useful contents to someone whose own consciousness remains in place. Comparison with Case's deck clarifies another boundary: the chip is local plug-in knowledge, while cyberspace access is an active connection to external systems. Collapsing those devices would erase distinct economies of skill, memory, and network access.",
        ],
      },
    ],
    related: ["neural-jacks-interfaces", "dermatrodes", "cyberspace-decks", "body-as-commodity", "chiba-medical-underground"],
    tags: ["microsoft", "skill chip", "implant", "knowledge", "wetware"],
    sourceKeys: ["novel", "gmu-notes", "william-gibson-wiki", "sf-encyclopedia"],
  },
  {
